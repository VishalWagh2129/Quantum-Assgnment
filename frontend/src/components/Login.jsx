...
function Login() {
  ...
  return (
    <div className="bg-secondary h-screen overflow-hidden flex items-center justify-center">
      ...
      <div className="bg-white text-dark p-3 rounded-top text-center">
        ...
        <form className="p-3">
          ...
          <button
            type="button"
            className="bg-primary from-gray-700 to-gray-900 font-medium p-2 md:p-4 text-white uppercase w-full rounded"
            onClick={login}>
            Login
          </button>
        </form>
